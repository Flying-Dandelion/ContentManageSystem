(function() {
    ...
    test( '检测图片是否正常缩放', function() {
        ...
        var dom = $('<div style="width:200px;">' +
                '<div><img src="../css/slider/image1.png" /></div>' +
                '<div><img src="../css/slider/image2.png" /></div>' +
                '<div><img src="../css/slider/image3.png" /></div>' +
    ...
    test( '只缩放指定类型图片', function() {
        ...
        var dom = $('<div style="width:200px;">' +
                '<div><img class="zoomme" src="../css/slider/image1.png" /></div>' +
                '<div><img class="ignoreme" src="../css/slider/image2.png" /></div>' +
            '</div>').appendTo( fixture ),
            items,
            count = 2;
